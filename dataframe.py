#Primer proyecto de uso de dataframes
...
tktk=['Tiktok',2000, False, 2020]

#Asignamos listas a una lista
lista_rrss=[fbk,twt,ig,yt,lkn,wsp,tktk]
...
df_rrss.to_csv("c:/Users/monst/Desktop/Python/dataframe/redes.csv")
